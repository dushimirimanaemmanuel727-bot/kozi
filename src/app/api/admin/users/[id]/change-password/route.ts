...
export async function GET(
  ...
  try {
    ...
    // Only allow self-change or admin/superadmin access
    if (!isSelfChange && !["admin", "superadmin"].includes(session.user.role?.toLowerCase())) {
    ...
    return NextResponse.json({
      ...
      message: isSelfChange 
        ...
        : "You can change this user's password as an admin."
    });
  } catch (error: unknown) {
