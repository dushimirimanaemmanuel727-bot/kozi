...
export default function AvailableWorkers({ workers, loading = false, error = false, onRetry }: AvailableWorkersProps) {
  if (loading) {
    return (
  ...
  if (error) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-500 mb-4">Unable to load workers at the moment</p>
        {onRetry && (
          <button
            onClick={onRetry}
